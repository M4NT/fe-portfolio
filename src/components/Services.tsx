              ...
              <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg overflow-hidden hover:border-white/20 transition-colors duration-300">
                ...
                >
                  <div className="flex items-center gap-4 flex-1">
                    {/* Icon & Info */}
                    <div className={`p-2.5 rounded-lg bg-gradient-to-br ${service.accent} shadow-lg`}>
                      ...
                      <div className="p-6 pt-6 bg-white/[0.02]">
                        <div className="grid md:grid-cols-2 gap-8">
                          ...
                          <div className="flex flex-col justify-between">
                            ...
                            <a
                              href="#contact"
                              className="group/btn relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-lg font-medium overflow-hidden transition-all hover:border-gray-600 hover:shadow-lg hover:shadow-gray-500/20"
                            >
                              {/* Shiny Text Effect */}
                              <span className="relative bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent font-semibold group-hover/btn:from-white group-hover/btn:via-white group-hover/btn:to-gray-300 transition-all duration-300">
                                Solicitar Orçamento
                              </span>
